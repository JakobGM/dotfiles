...
return {
    ...
    keys = {
        ...
        { "<leader>gN", "<Plug>(coc-git-prevchunk)" },
        { "<leader>gn", "<Plug>(coc-git-nextchunk)" },
        -- Hunk-add and hunk-revert for chunk staging
        { "<leader>ga", ":CocCommand git.chunkStage<CR>" },
        { "<leader>gu", ":CocCommand git.chunkUndo<CR>" },
        -- Show chunk diff at current position
        { "<leader>gd", "<Plug>(coc-git-chunkinfo)" }
    },
}
